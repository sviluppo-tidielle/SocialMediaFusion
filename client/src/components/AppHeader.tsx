        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 p-3 border-b border-slate-100">
              ...
              <div>
                <p className="text-sm"><span className="font-medium">Sofia</span> liked your post.</p>
            ...
            <div className="flex items-start gap-3 p-3 border-b border-slate-100">
              ...
              <div>
                <p className="text-sm"><span className="font-medium">Marco</span> commented on your photo.</p>
            ...
            <div className="flex items-start gap-3 p-3 border-b border-slate-100">
              ...
              <div>
                <p className="text-sm"><span className="font-medium">Antonio</span> started following you.</p>
